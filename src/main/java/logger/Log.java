...
public class Log {
    ...
    public static void INFO(String log) {
        ...
        System.out.println("[INFO]" + "[" + getClassName + "."+ getMethodName + ":" + getLineNumber + "]" + " - " + log);
    }
    ...
    public static void ERROR(String log) {
        ...
        String getMethodName = Thread.currentThread().getStackTrace()[2].getMethodName();
        String getClassName = Thread.currentThread().getStackTrace()[2].getClassName();
        System.err.println("["+RED+"ERROR"+RESET+"]" +RED+"[" + getClassName + "."+ getMethodName + ":" + getLineNumber + "]" + " - " + log+ RESET);
    }

    public static void PASS(String log) {
        System.setProperty("org.uncommons.reportng.escape-output", "false");
        System.out.println(GREEN_BOLD+"[PASS] <=========== " + log+ RESET);
    }

    public static void FAIL(String log) {
        System.setProperty("org.uncommons.reportng.escape-output", "false");
        System.out.println(RED+"[FAIL] <=========== " + log+ RESET);
    }
    ...
    public static void SKIP(String log) {
        ...
        int getLineNumber = Thread.currentThread().getStackTrace()[2].getLineNumber();
        String getMethodName = Thread.currentThread().getStackTrace()[2].getMethodName();
        System.out.println("[SKIP] " + "[" + getMethodName + ":" + getLineNumber + "]" + " - " + log);
    }
